...
# Schedules
execute if score #countdown countdown matches 1.. run schedule function mafia:game/countdown/countdown 2s
execute if score #countdown countdown matches 0 run schedule function mafia:game/countdown/youare 2s